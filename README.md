<h1 align="center">CoCart Settings Example</h1>
...
![Screenshot of example settings](https://raw.githubusercontent.com/co-cart/cocart-settings-example/master/screenshot.png)

## Main directories and files

- `cocart-settings-example.php` - The main plugin file. ONLY used when using this package as a plugin!
...
- `includes/settings/class-cocart-admin-settings-example.php` - Stores all the settings for your own. Examples of use have been provided for each supported method.
- `includes/class-cocart-settings-example.php` - The core setup for enabling the settings. The package class requires 1 static method; 
...
CoCart Settings Example is developed and maintained by [Sébastien Dumont](https://github.com/seb86).
